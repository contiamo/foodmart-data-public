...
#
# If successful, this will upload a fresh sqlserver+foodmart image to the container registry.

DOCKER_SRC_IMG=mcr.microsoft.com/mssql/server:2017-latest
DOCKER_TARGET_IMG=eu.gcr.io/dev-and-test-env/foodmart-mssql:v0.0.1
...
# Load data
../../FoodMartLoader.sh --db sqlserver --db-host localhost
